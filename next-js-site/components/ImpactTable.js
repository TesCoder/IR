          ...
          <tbody className="divide-y divide-gray-200 text-sm">
            {data.map(({ name, acceptanceRate, ivyReadyRate, ivyReadyImpact }) => (
              <tr key={name} className="hover:bg-gray-50 transition-colors">
                <td className="px-4 py-3 text-gray-900 font-semibold whitespace-nowrap">{name}</td>
                <td className="px-4 py-3 text-gray-700 whitespace-nowrap">{acceptanceRate}</td>
                <td className="px-4 py-3 text-gray-700 whitespace-nowrap">{ivyReadyRate}</td>
                <td className="px-4 py-3 text-gray-700 whitespace-nowrap">{ivyReadyImpact}</td>
              </tr>
            ))}
          </tbody>
        </table>
