    ...
    <section aria-labelledby="packages-compare-title" className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-400">
          We offer Essays-only Support, Comprehensive Support, and Comprehensive Support with Logistics. All packages come with unlimited hours of essay editing and admission support. (In addition, we offer hourly consultationand Application Evaluation.)
        </p>
      </div>
