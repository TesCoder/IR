...
const Button = ({ props, children }) => <button className='bg-ivy-red text-white py-2 px-4 mx-16 rounded-3xl transition-colors hover:bg-red-700' {...props}>{...children}</button>

const Profile = ({ imgSrc, name }) => (
  <div className='w-1/6 flex flex-col items-center mx-2'>
    <Image className='rounded-full shadow-md mb-2' src={imgSrc} width={128} height={128} alt=" profile picture" />
    <p className='text-ivy-blue  font-semibold'>{name}</p>
  </div>
  ...
  return (
    <>
      ...
      <div className='bg-gray-100 flex items-center justify-center '>
        <div className='flex flex-col items-center py-16 w-3/5 '>
          <h1 className='font-light text-4xl text-center text-ivy-blue'>Apply with Confidence</h1>
          ...
          <div className='my-5'>
            ...
            <Button>Get a Quick Call</Button>
      ...
      <div className='flex flex-col items-center py-16 italic'>
        <h1 className='font-light text-4xl text-center  text-ivy-blue mb-5'>
          Our stellar record speaks for itself!
        </h1>
        <Image src='/images/scans.jpeg' width={1080} height={500} alt="Record" />
        <h3 className='font-semibold text-lg my-4 text-gray-500 uppercase'>Ask for original copies!</h3>
        <Button>Contact Us</Button>
      </div>

      <div className='bg-gray-100 flex flex-col items-center py-16'>
        <div className='w-3/5 flex flex-col items-center'>
          <h1 className='font-light text-3xl text-center  text-ivy-blue mb-5'>
      ...
      <div className='flex flex-col items-center py-16'>
        <div className='w-3/5'>
          <h1 className='font-light text-4xl   text-ivy-blue mb-3'>
            Ivy Ready Application Support Packages
          </h1>
      ...
      <div className=' bg-gray-100 flex flex-col items-center py-16 '>
        <div className='w-3/5'>
          <h1 className='font-light text-center text-4xl text-ivy-blue mb-3'>
            Testimonials
          </h1>
          {/* Bootstrap Carousel */}
