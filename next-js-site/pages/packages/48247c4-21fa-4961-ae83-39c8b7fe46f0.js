...
export async function getServerSideProps(context) {
  ...
  if (ejau34ouap !== "L0cKw1r3-Qv8Z72Pk") {
    return {
    ...
    <>
      ...
      <Section title="Ivy Ready Application Support Fee Structure">
        ...
        <ul className="list-disc pl-6 mb-4">
            <li>
              <strong>Essays-Only Support up to 5 Schools:</strong> $8,000 <span className="text-gray-500">(Save $1,000 from $9,000)</span>
            </li>
            <li>
              <strong>Essays-Only Support up to 10 Schools:</strong> $10,000 <span className="text-gray-500">(Save $1,000 from $11,000)</span>
            </li>
            <li>
              <strong>Comprehensive Support up to 5 Schools:</strong> $10,000 <span className="text-gray-500">(Save $1,000 from $11,000)</span>
            </li>
            <li>
