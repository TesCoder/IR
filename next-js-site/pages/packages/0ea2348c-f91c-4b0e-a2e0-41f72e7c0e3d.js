...
const RT = "s4rX9hz0L_q72-Fv90tzP"; // token-gated; exclude `/packages/*` from prod tests
  ...
  return (
    <>
      <SEOHead
        ...
        url="/packages/0ea2348c-f91c-4b0e-a2e0-41f72e7c0e3d"
      />
      ...
      <SchemaScript
        schema={ServiceSchema({
          ...
          serviceUrl: "https://ivyready.com/packages/0ea2348c-f91c-4b0e-a2e0-41f72e7c0e3d",
      ...
      <div className="max-w-6xl mx-auto px-4 pt-4">
        <Breadcrumbs
          items={[
            ...
            { name: "Application Support Fee Structure", url: "/packages/0ea2348c-f91c-4b0e-a2e0-41f72e7c0e3d" },
          ]}
        />
      </div>
      ...
      <Section title="Ivy Ready Application Support Fee Structure">
        ...
        <ul className="list-disc pl-6 mb-4">
          <li>
            <strong>Essays-Only Support up to 5 Schools:</strong> $4,000 <span className="text-gray-500">(Save $1,000 from $5,000)</span>
          </li>
          <li>
            <strong>Essays-Only Support up to 10 Schools:</strong> $6,000 <span className="text-gray-500">(Save $1,000 from $7,000)</span>
          </li>
          <li>
            <strong>Comprehensive Support up to 5 Schools:</strong> $6,000 <span className="text-gray-500">(Save $1,000 from $7,000)</span>
          </li>
          <li>
            <strong>Comprehensive Support up to 10 Schools:</strong> $8,000 <span className="text-gray-500">(Save $1,000 from $9,000)</span> <span className="text-green-600 font-semibold">[Most common]</span>
          </li>
          <li>
            <strong>Full Application Support up to 5 Schools:</strong> $8,000 <span className="text-gray-500">(Save $1,000 from $9,000)</span>
          </li>
          <li>
            <strong>Full Application Support up to 10 Schools:</strong> $10,000 <span className="text-gray-500">(Save $1,000 from $11,000)</span>
          </li>
        </ul>
