    ...
    <>
      <Section>
        <h1 className="font-medium md:font-light text-2xl md:text-4xl text-ivy-blue" >
          Submit your best application with the feedback of former admission officers! (<strong className="font-bold">Sign Up</strong>)
        </h1>
      </Section>

      <Section darkBg title="A one-of-a-kind evaluation for a once-in-a-lifetime opportunity">
        <Image src='/images/sample-evaluation.png' width={1080} height={500} alt="Record" />
        <p className=" text-xl text-center my-3 text-gray-700">
          Ivy Ready Evaluation makes it easy to identify key areas of improvement. While supplemental essays are unique to each school, a large percentage of the application is sent to many schools. Thus, insights gained from a single evaluation can help students find ways to improve their likelihood of admission to multiple schools.
        </p>
      </Section>
      ...
      <Section centerContent darkBg>
        ...
        <h2 className="font-semibold text-2xl text-center">Evaluation Package Components:</h2>
        <p className="text-xl text-center my-2 text-gray-700">
          Ivy Ready Evaluation is a unique opportunity for prospective applicants to enhance their college applications with the feedback of former admissions officers. While Ivy Ready does offer comprehensive Application Support Packages, this evaluation is available for students who prefer to work on their application independently but receive feedback before official submission.
        </p>
      </Section>
      ...
      <Section centerContent title="Understanding the Evaluation">
        <p className="text-xl text-center my-2 text-gray-700">In addition to highlighting the primary strength, setback, and potential area of improvement of the applicant, the evaluation determines the competitiveness of high key areas using a rating scale.</p>
        <Image src='/images/rating-scale.png' width={600} height={500} alt="Scale" />
        <p className="text-xl text-center my-2 text-gray-700">Understanding the scale: if a key area meets the <strong>highest</strong> Ivy Ready Standards, a rating of Ivy Ready is assigned next to that key area on the evaluation report. Otherwise, the report will state Outstanding (above average), Competitive (average), or Developing (below average) as appropriate.</p>
      </Section>
      <Section darkBg>
        <div className="grid gap-6 grid-cols-1 md:grid-cols-2">
          <Goal title="Get Actionable Insights"
          ...
          <Goal title="Impress your Dream School"
          ...
          <Goal title="Your Best Investment Yet"
      ...
      <Section>
        <Image className="mx-auto mb-4" src='/images/ivy-eval.png' width={200} height={200} alt="Scale" />
        ...
        <p className="mb-2 text-lg text-gray-700">
          <strong>Single-School Evaluation</strong> includes a holistic review of the core application and supplemental essays to one school. The evaluation report will highlight key areas of improvement and a 30-minute phone discussion is included.
        </p>
        <p className="mb-2 text-lg text-gray-700">
          <strong>Multiple-School Evaluation</strong> includes a holistic review of the core application and supplemental essays up to five schools. (Discounted rate is offered for this option.)
        </p>
