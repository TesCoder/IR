...
rail:
  slug: "/blog/how-to-choose-recommenders"
  title: "How to Choose the Right Recommenders"
  destination: "/blog/how-to-choose-recommenders"
  type: "blog"
...
If you’re building impact through activities, skim [How to Choose Extracurriculars for College](/blog/how-to-choose-extracurriculars-for-college) so the proof you create there is easy for recommenders to cite. Keep filing deadlines clean with the [Financial Aid & Merit Strategy Hub](/blog/financial-aid-merit-hub) so letter timing matches FAFSA/CSS steps.
...
## Quick navigation
- [What makes a letter strong](#what-makes-a-recommendation-strong)
- [Who to choose (criteria + rubric)](#who-to-choose-the-practical-criteria)
- [Narrative alignment](#how-to-align-recommenders-with-your-narrative)
- [Timeline](#timeline-ask-earlier-than-you-feel-comfortable)
- [What to give them (packet)](#what-to-give-your-recommender-your-packet)
- [Extra letters decision](#extra-letters)
- [FAQ](#quick-faq)
...
| Your situation | Best recommender type | Why |
|---|---|---|
| Standard 2-letter requirement | 1 STEM + 1 humanities (recent, core subjects) | Coverage + complementary evidence |
| All options are equally good | Highest total on the 4-factor rubric | Removes gut-feel bias |
| 1 strong + 1 weaker option | Strong teacher first; coach/mentor as second only if they add new evidence | New proof beats repeated proof |
| Adding an optional extra letter | Only if it adds unique proof teachers cannot cover (research, leadership, responsibility) | One new dimension only |
| Teacher recently left the school | Still fine if they know you well and will write clearly and on time | Quality over institutional status |
...
- [College Interview Prep Hub](/blog/interview-prep-hub) — Use this if you’re prepping for common questions and want a clear practice plan.  
- [Teacher Recommendation Request Template](/blog/teacher-recommendation-request-template) — Copy/paste request email + follow-up timing so you ask early without awkwardness.  
- [ED vs EA vs RD Admissions Calendar](/blog/ed-vs-ea-vs-rd-admissions-calendar) — Use this to map deadlines (and back-plan when to request letters).  
- [College Application Checklist](/resources/college-application-checklist) — Use this if you want an end-to-end timeline to track your whole application.
