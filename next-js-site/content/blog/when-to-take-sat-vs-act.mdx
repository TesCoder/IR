...
rail:
  slug: "/blog/when-to-take-sat-vs-act"
  title: "When to Take the SAT vs ACT"
  destination: "/resources/downloads/sat-vs-act-timeline-planner.pdf"
  type: "blog"
  slot: "article_related"
  ctaPayload:
    event: "guide_download"
    location: "article_related"
    text: "Download SAT vs ACT timeline planner (PDF)"
    destination: "/resources/downloads/sat-vs-act-timeline-planner.pdf"
...
<a
  href="/resources/downloads/sat-vs-act-timeline-planner.pdf"
  ...
  onClick={() => {
    ...
    window.dataLayer.push({
      event: "guide_download",
      location: "article_related",
      text: "Download SAT vs ACT timeline planner",
      destination: "/resources/downloads/sat-vs-act-timeline-planner.pdf",
    });
  }}
>
