...
description: "Four-part framework (Fit/Depth/Proof/Sustainability) for evaluating whether a specific activity is worth your time — individual activity decisions, not portfolio shape."
...
This post helps you evaluate whether a specific activity is worth your time — using a four-part scoring framework. For portfolio-level strategy (spike vs. well-rounded, redundancy), see [Spike vs Well-Rounded: Building Your Extracurricular Profile](/blog/spike-vs-well-rounded-extracurricular-profile).
