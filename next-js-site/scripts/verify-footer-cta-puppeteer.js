// scripts/verify-footer-cta-puppeteer.js
// usage: URL="http://localhost:3000" node scripts/verify-footer-cta-puppeteer.js
...
(async () => {
  ...
  const CTA_SELECTOR = 'footer a[href="/#application-support-questions-section"]';
  ...
  out.afterLength = await page.evaluate(() => window.dataLayer.length);

  const filename = `reports/assets/footer-cta-datalayer-${Date.now()}.json`;
